...
def attack(char_name: str, char_class: str) -> str:
    ...
    return ('урон по противнику не нанесен')


def defence(char_name: str, char_class: str) -> str:
    """Функция блокирует урон в завимимости от класса персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция применение специального умения персонажем."""
    if char_class == 'warrior':
        return (f'{char_name}'
    ...
    return ('вы оглушены противником')


def start_training(char_name: str, char_class: str) -> str:
    """Функция описывает особенности выбора класса."""
    if char_class == 'warrior':
